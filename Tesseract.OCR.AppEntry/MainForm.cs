...
namespace Tesseract.OCR.AppEntry
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            Point[] pts = null;
            UpdateImageViewer(pts);

            Polygon[] polys = null;
            UpdateImageViewer(polys);
        ...
        private void UpdateImageViewer(Point[] pts)
        {
            imageViewer.Points = pts;
            imageViewer.Invalidate(true);
        }

        private void UpdateImageViewer(Polygon[] polys)
        {
            imageViewer.Regions = polys;
            imageViewer.Invalidate(true);
        }
